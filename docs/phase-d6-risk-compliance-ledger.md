...
| 11 | Source links typed وآمنة | **جزئي** | نمطي بالكامل (Verified)، لكن التحقق من النطاق غير مكتمل لكل الأنواع — انظر بند 11-ب أدناه والفجوة في `phase-d6-risk-source-linking.md`. |
| 11-ب | تحقق نطاق شامل لكل أنواع المصادر | Missing | 5 من 18 نوعًا فقط لديها تحقق نطاق فعلي؛ الباقي يُقبل بلا تحقق (موثَّق كفجوة أمنية). |
...
4. تحقق نطاق كامل لكل أنواع `RiskSourceEntityType` (13 من 18 نوعًا بلا تحقق).
