...
public static class RoleHierarchy
{
    private static readonly Dictionary<string, int> Ranks = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [RoleCodes.FormApprover] = 335,
        [RoleCodes.FormPublisher] = 330,
        [RoleCodes.FormRegionalMonitor] = 320,
        [RoleCodes.FormHeadquartersMonitor] = 325,
        [RoleCodes.FormAnalyst] = 315,
        [RoleCodes.FormRespondent] = 310,
