...
{
    /// <inheritdoc />
    public partial class InitialPhaseA : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserScopeSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Outcome = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    IsSensitiveView = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExternalSubject = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FacilityUnits_FacilityUnits_ParentUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacilityAssetLocations", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserScopes_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserScopes_FacilityUnits_FacilityUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityAssetLocations_BuildingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityUnits_ParentUnitId",
                table: "FacilityUnits",
                column: "ParentUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserScopes_FacilityId",
                table: "UserScopes",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_UserScopes_FacilityUnitId",
                table: "UserScopes",
